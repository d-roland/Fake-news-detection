...
![alt text](https://github.com/d-roland/Fake-news-detection/tree/master/.ipynb_checkpoints/WordCloud_real.png?raw=true)
...
0.99
0.99
Accuracy of our models after training based on initial preprocessing
...
Test set classification report for Naïve Bayes model

Test set classification report for SVM linear classifier
...
Most important features for Naive Bayes model 


(fake news appear in Red, real news in Blue, and most important at the bottom of the graph)
Most frequent terms
 in each corpus
...
Train and validation Losses for LSTM model
...
Result of BERT evaluation on Test set
...
But the words highlighted there, and the tone employed, were pretty consistent with the major trends we obtained from sentiment analysis libraries Vader and TextBlob applied to each corpus of our dataset, as shown in the pictures below.
            Sentiment distribution of each corpus
Subjectivity distribution of each corpus
